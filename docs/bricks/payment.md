...
| `defaultPaymentOption.prepaidCardForm`  | `boolean`            | When `true`, the form loads with credit card form selected, since most prepaid cards are classified as credit single-installments.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | **OPTIONAL** |
