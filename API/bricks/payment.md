...
| `savedCards` | `string[]` | Saved Cards Ids. If defined in conjunction with Customer ID, the buyer will be able to used their saved cards in checkout. [See More](https://www.mercadopago.com.br/developers/pt/reference/cards/_customers_customer_id_cards/post)  | 
