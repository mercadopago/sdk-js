...
| `texts.valueProp`¹         | `string`  | Defines the value prop. Options available: `practicality`, `convenience`, `security_details`, `security_safety`, `credits` and `smart`. Default is `security_safety`. | **OPTIONAL** |
